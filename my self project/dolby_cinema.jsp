...
<head>
    ...
    <link rel="stylesheet" href="../css/dolby.css">
    <script defer src="../js/dolby.js"></script>
 </head>
  
<body>          
<div class="theater-specail-cont">  
  <div class="inner-wrap pt40">
    <div class="tab-list fixed mb40 on">
				<ul id="tab-list">
					<li class="on">
					  <div onclick="time()" data-target="sectionInfo" title="DOLBY CINEMA 소개 탭으로 이동">DOLBY CINEMA 소개</div>
					<li>
					<div onclick="move()" data-target="sectionInfo" title="상영시간표 탭으로 이동">상영시간표</div>
			     </li>
				</ul>
			  </div>
			</div>
			<!-- section -->
 <div onclick="Composition()">
   <!-- bg-wrap -->
   <div class="bg-wrap">
    ...
    <div class="cont-theater">
	  <div class="col-group col-1">
		<div class="col">
		  <p class="img">
		    <img class="bread" src="https://img.megabox.co.kr/static/pc/images/theater/img-theater-db-view01.png" alt>
		   </p>
		 </div>
	   </div>
     </div>
