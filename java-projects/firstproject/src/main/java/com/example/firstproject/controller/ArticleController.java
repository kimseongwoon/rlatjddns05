...
@Controller
@Slf4j  // 로깅을 위해 사용하는 어노테이션
public class ArticleController {
    @Autowired  // 스프링부투가 미리 생생해 놓은 레파지토리 객체 주입(DI(Dependency Injection))
...
//    public String createArticle(String title, String content) { // ArticleForm은 DTO 성격을 가진 class
        ...
        //ArticleRepository articleRepository2 = new ArticleRepositoryImpl();
...
//        System.out.println(saved);
        ...
        return "redirect:/articles/" + saved.getId(); // 저장된 데이터의 상세페이지로 이동
    }
    ...
    public String show(@PathVariable Long id, Model model) {     // 매개변수로 id 받아오기
        ...
        List<CommentDto> commentDtoList = commentService.comments(id);
