    		...
    		<div class="col">
    		 <div class="card">
               <div class="card-header">
	   		   ...
	   		   <div class="card-body">
	   		   		<form action="/spring-jsp-boot1/todo/modify" method="post">
					...
					<script>
						...
						// Remove버튼을 클릭을 했을 때 동작
						document.querySelector(".btn-danger").addEventListener("click",function(e) {
	                        e.preventDefault();
	                        e.stopPropagation();
	
	                        // 삭제 controller 매핑으로 변경
	                        formObj.action = `/spring-jsp-boot1/todo/remove`;
	                           formObj.method = "post";
	
	                        formObj.submit();
	                     }, false);
						
						// Modify버튼을 클릭을 했을 때 동작
						document.querySelector(".btn-primary").addEventListener("click",function(e) {
                            e.preventDefault()
                            e.stopPropagation()

                            formObj.action ="/spring-jsp-boot1/todo/modify"
                            formObj.method ="post"
