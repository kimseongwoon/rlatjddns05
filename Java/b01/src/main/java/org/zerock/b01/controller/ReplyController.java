...
public class ReplyController {
    ...
    @ApiOperation(value = "특정 게시물의 댓글 목록", notes = "GET 방식으로 측정 게시물의 댓글 목록")
    ...
    @ApiOperation(value = "특정 댓글 조회", notes = "GET 방식으로 특정 댓글 조회")
    ...
    @ApiOperation(value = "특정 댓글 삭제", notes = "DELETE 방식으로 특정 댓글 삭제")
    ...
    @ApiOperation(value = "특정 댓글 수정", notes = "PUT 방식으로 특정 댓글 수정")
