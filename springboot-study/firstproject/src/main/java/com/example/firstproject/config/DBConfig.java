...
@MapperScan(basePackages = {"com.example.firstproject.dao.mapper"})   // Mapper 인터페이스를 스캔하여 Bean으로 등록
...
//        hikariConfig.setPassword("1234");
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://localhost:3306/search_region");
